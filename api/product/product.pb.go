...
type ListProductsRequest struct {
	...
	MinPriceCents *int64                 `protobuf:"varint,7,opt,name=min_price_cents,json=minPriceCents,proto3,oneof" json:"min_price_cents,omitempty"`
	MaxPriceCents *int64                 `protobuf:"varint,8,opt,name=max_price_cents,json=maxPriceCents,proto3,oneof" json:"max_price_cents,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListProductsRequest) GetMinPriceCents() int64 {
...
func (x *ListProductsRequest) GetMaxPriceCents() int64 {
...
const file_api_product_product_proto_rawDesc = "" +
	"\n" +
	"\x19api/product/product.proto\x12\aproduct\"\xe0\x01\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\aproduct\x18\x01 \x01(\v2\x10.product.ProductR\aproduct\"\xad\x02\n" +
	...
	"\x0fmin_price_cents\x18\a \x01(\x03H\x00R\rminPriceCents\x88\x01\x01\x12+\n" +
	"\x0fmax_price_cents\x18\b \x01(\x03H\x01R\rmaxPriceCents\x88\x01\x01B\x12\n" +
	"\x10_min_price_centsB\x12\n" +
	"\x10_max_price_cents\"Z\n" +
	"\x14ListProductsResponse\x12,\n" +
	"\bproducts\x18\x01 \x03(\v2\x10.product.ProductR\bproducts\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x03R\x05total\"\xb8\x02\n" +
