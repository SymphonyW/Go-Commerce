...
func (x *GetCartResponse) GetTotalAmountCents() int64 {
	if x != nil {
...
const file_api_cart_cart_proto_rawDesc = "" +
	"\n" +
	"\x13api/cart/cart.proto\x12\x04cart\"\xa6\x01\n" +
	"\bCartItem\x12\x1d\n" +
	"\n" +
	...
	"\x12total_amount_cents\x18\x02 \x01(\x03R\x10totalAmountCents\"k\n" +
	...
	"\tClearCart\x12\x16.cart.ClearCartRequest\x1a\x17.cart.ClearCartResponseB\x16Z\x14go-commerce/api/cartb\x06proto3"

var (
	file_api_cart_cart_proto_rawDescOnce sync.Once
	file_api_cart_cart_proto_rawDescData []byte
)

func file_api_cart_cart_proto_rawDescGZIP() []byte {
	file_api_cart_cart_proto_rawDescOnce.Do(func() {
		file_api_cart_cart_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_cart_cart_proto_rawDesc), len(file_api_cart_cart_proto_rawDesc)))
	})
	return file_api_cart_cart_proto_rawDescData
}

var file_api_cart_cart_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
func file_api_cart_cart_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_cart_cart_proto_rawDesc), len(file_api_cart_cart_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
