...
const file_api_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x13api/auth/auth.proto\x12\x04auth\"s\n" +
	...
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB\x16Z\x14go-commerce/api/authb\x06proto3"
